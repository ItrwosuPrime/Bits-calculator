...
def instructions():
    ...
    print("""
Press keys for filetypes.
Type "integer" or "int" to get a integer calc
type "image", "picture", "img", or "p" to get a image calc
type "text", "txt", or "t" to get a text calc 
Type "i" to get a choice between a integer and a image calc
